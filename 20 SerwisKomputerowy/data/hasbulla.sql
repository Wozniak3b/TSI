...
--
-- Host: 127.0.0.1
-- Czas generowania: 10 Lis 2021, 01:07
...
CREATE TABLE `zamowienia` (
  `id` int(11) NOT NULL,
  `imie` varchar(80) COLLATE utf8mb4_polish_ci NOT NULL,
  `nazwisko` varchar(80) COLLATE utf8mb4_polish_ci NOT NULL,
  `tel` varchar(15) COLLATE utf8mb4_polish_ci NOT NULL,
  `sprawa` varchar(80) COLLATE utf8mb4_polish_ci NOT NULL,
  `problem` text COLLATE utf8mb4_polish_ci NOT NULL,
  `producent_laptopa` varchar(30) COLLATE utf8mb4_polish_ci NOT NULL DEFAULT '----',
  `model` varchar(30) COLLATE utf8mb4_polish_ci NOT NULL DEFAULT '----',
